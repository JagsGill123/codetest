 ...
 */
final class Version20190829001841 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE country (id INT AUTO_INCREMENT NOT NULL, capital VARCHAR(255) DEFAULT NULL, flag LONGTEXT DEFAULT NULL, dialing_code VARCHAR(255) DEFAULT NULL, region VARCHAR(255) DEFAULT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
